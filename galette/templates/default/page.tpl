...
{if $login->isAdmin()}
        ...
        <ul>
            ...
            <li{if $cur_route eq "entitleds" and $cur_subroute eq "contributions-types"} class="selected"{/if}><a href="{path_for name="entitleds" data=["class" => "contributions-types"]}" title="{_T string="Manage contributions types"}">{_T string="Manage contributions types"}</a></li>
            ...
            <li><a href="{$galette_base_path}pdf_adhesion_form.php" title="{_T string="Download empty member file card"}">{_T string="Empty member file card"}</a></li>
        </ul>
{/if}
